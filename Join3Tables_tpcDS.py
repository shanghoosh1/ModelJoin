...
with open('clusters/tpc_ds/3_way/freq_tbl0_att1.txt', 'r') as file:
    jTBL0_1=(json.load(file))
with open('clusters/tpc_ds/3_way/freq_tbl1_att0.txt', 'r') as file:
    jTBL1_0=(json.load(file))
with open('clusters/tpc_ds/3_way/freq_tbl1_att1.txt', 'r') as file:
    jTBL1_1=(json.load(file))
with open('clusters/tpc_ds/3_way/freq_tbl2_att0.txt', 'r') as file:
    jTBL2_0=(json.load(file))

############################################################################################## 2 fetch necessary embeddings
# table="embeddings/store_sales_customers_items_stores_embedings.txt"
table="embeddings/tpc_ds/3_way/store_sales/Embedding__att0_embed.txt"
...
import json
with open('clusters/tpc_ds/3_way/50c/tbl1_att1clust_dict50.txt', 'r') as file:
    clus_dict=(json.load(file))
with open('clusters/tpc_ds/3_way/50c/tbl1_att1freq_dict50.txt', 'r') as file:
    freq_dict=(json.load(file))
################################################################################################ 5 Dynamic programming
add = 'clusters/tpc_ds/3_way/50c/models/model_tbl1_'
out_add='tpc_ds/3_way/server_t0t1t2/'
manager = Manager()
...
def dyn_prog_MP(tasks_to_accomplish,clus_dict,freq_dict,M1_embedings ):
    ...
    for i in range(num_clusters1):
        model = learner.DMDN(no_layers=5, no_hidden=300)
